package com.banshion.portal.util.ueditor;
...
public class FileManagerExtend{
    ...
    public FileManagerExtend(Map<String, Object> conf) {
        ...
        if(StringUtils.isNotBlank(uploadPath) && uploadPath.startsWith("/") ){
            this.dir = uploadPath;
        }else{
    ...
    private State getState(Object[] files) {
        ...
        for(int var6 = 0; var6 < var7; ++var6) {
            ...
            //  文件读取路径设置为 配置的
            fileState.putInfo("url", contextPath+CommonPlaceholderConfigurer.getContextProperty("visitpath")
                    +""+file.getName() ); //  PathFormat.format(this.getPath(file))
